...
void image_layer::update(int width, int height)
{
    ...
    *m_cLUT, m_red, m_green, m_blue);
    ...
    screen_image_visitor siv(screen_view, my_cc, m_zoomFactor, m_translationX, m_translationY,m_layer_orientation, alpha_view, m_transparencyMin, m_transparencyMax, m_alpha, transparent());
...
*/
    wxPoint pt=to_local(wxPoint(i,j));
