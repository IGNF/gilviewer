...
BEGIN_EVENT_TABLE(selectable_static_text, wxStaticText)
    EVT_LEFT_DOWN(selectable_static_text::OnClick)
END_EVENT_TABLE()

void selectable_static_text::OnClick(wxMouseEvent& event)
{
	...
	m_parent(parent), m_index(index)
{
    ...
    m_visibilityCheckBox->Connect(ID_VISIBILITY + m_index, wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(layer_control::OnCheckVisibility), NULL, m_parent);
    ...
    m_transformationCheckBox->Connect(ID_TRANSFORMATION + m_index, wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(layer_control::OnCheckTransformable), NULL, m_parent);
    ...
    m_infoButton->Connect(ID_INFO + m_index, wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(layer_control::OnInfoButton), NULL, m_parent);
    ...
    m_saveButton->Connect(ID_SAVE + m_index, wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(layer_control::OnSaveButton), NULL, m_parent);
    ...
    m_deleteButton->Connect(ID_DELETE + m_index, wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(layer_control::OnDeleteButton), NULL, m_parent);
    ...
    m_settingsButton->Connect(ID_SETTINGS + m_index, wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(layer_control::OnSettingsButton), NULL, m_parent);
    ...
    m_center_button->Connect(ID_CENTER + m_index, wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(layer_control::OnCenterButton), NULL, m_parent);
